...
class SensatUrban(object):
    def __init__(self, root_path, split="train", keep_idx=False, img_h=320, img_w=320, use_crop=False):
        ...
        for file_name in os.listdir(self.split_folder):
            if ".pth" in file_name and "cambridge_block_1" not in file_name and "cambridge_block_0" not in file_name:
            # if ".pth" in file_name and "cambridge_block_1" not in file_name and "cambridge_block_0" not in file_name and "birmingham_block_11" not in file_name and "birmingham_block_13" not in file_name and "cambridge_block_34" not in file_name:
                # skip cambridge_block_1 /0  (tiny block) to avoid error
