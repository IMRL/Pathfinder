...
class Experiment(object):
    def __init__(self, settings: Option):
        ...
        self.epoch_start = 0
        # init model
        self.model = pc_processor.models.Pathfinder_Sensaturban_Binary(
            pcd_channels=5,
            img_channels=3,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_path", type=str, metavar="config_path",
                        default="/home/m/Documents/GitHub/Pathfinder/tasks/sensat_urban/pathfinder_binary/config_server.yaml",
